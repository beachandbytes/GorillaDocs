  ...
  <Fragment>
    ...
    <DirectoryRef Id="PRODUCTLOCATION">
      <Component Id="PowerPointAddin" Guid="[GUID]" Transitive="yes" Win64="$(var.Property_Win64)">
        ...
        <RegistryKey Action="createAndRemoveOnUninstall" Key="Software\Microsoft\Office\[POWERPOINTVERSIONKEYNAME]\User Settings\MacroView.PowerPoint\Create\Software\Microsoft\Office\PowerPoint\Addins\[Property_ProductName]" Root="HKLM">
        ...
        <RegistryKey Action="createAndRemoveOnUninstall" Key="Software\Microsoft\Office\[POWERPOINTVERSIONKEYNAME]\User Settings\MacroView.PowerPoint\Create\Software\Microsoft\VSTO\Security\Inclusion\[GUID]" Root="HKLM">
