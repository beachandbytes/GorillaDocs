  ...
  <Fragment>
    ...
    <DirectoryRef Id="PRODUCTLOCATION">
      <Component Id="WordAddin" Guid="[GUID]" Transitive="yes" Win64="$(var.Property_Win64)">
        ...
        <RegistryKey Action="createAndRemoveOnUninstall" Key="Software\Microsoft\Office\[WORDVERSIONKEYNAME]\User Settings\MacroView.Word\Create\Software\Microsoft\Office\Word\Addins\[Property_ProductName]" Root="HKLM">
        ...
        <RegistryKey Action="createAndRemoveOnUninstall" Key="Software\Microsoft\Office\[WORDVERSIONKEYNAME]\User Settings\MacroView.Word\Create\Software\Microsoft\VSTO\Security\Inclusion\[GUID]" Root="HKLM">
